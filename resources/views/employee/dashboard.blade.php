                     ...
                     <div class="tab-content">
                        ...
                        <div id="incidentInfo" class="tab-pane fade active show active">
                            ...
                            <ul class="incident-information d-flex justify-content-between">
								 @php //$Countall=App\Helpers\UserHelper::Countall();
									    $Pendingrm=App\Helpers\UserHelper::Pendingrm();
										$Pendingsh=App\Helpers\UserHelper::Pendingsh();
										$Close=App\Helpers\UserHelper::Close();
										$Draft=App\Helpers\UserHelper::DraftInci();
										$Countall = $Pendingrm+$Close+$Draft+$Pendingsh;
								 @endphp                                            
                                <li>
                                ...
                                <li>
                                    <div class="incidentNumberBlock closedIncident"><span class="incidentNumber">{{ $Pendingrm}}</span><a href="{{url('admin/admin-pendrm')}}" class="incidentTxt">Pending Incidents with Reporting Manager</a></div>
                                </li>
								...
								@php $Draft=App\Helpers\UserHelper::DraftInci(); @endphp                                            
                                <li>
                                    <div class="incidentNumberBlock draftIncident"><span class="incidentNumber">{{ $Draft }}</span><a href="{{url('admin/admin-drafttable')}}" class="incidentTxt">Draft Incidents</a></div>
                                </li>	
                            </ul>
                            <!-- ======= start: searc-hpanel ======= -->
                                    ...
                                    <thead>                                      
                                       ...
                                       @if(!empty($tabledata))  
                                               <tbody id="search_data">
                                                ...
                                                @if($table->save_draft == 0)                                                
                                                <td>
												<a href="{{ url('admin/employee-incident-edit').'/'.$table->in_id}}">Edit</a> | 
												<a href="{{ url('admin/employee-incident-view').'/'.$table->in_id}}">View</a> |
												<a href="{{ url('admin/employee-incident-delete').'/'.$table->in_id}}">Delete</a>
												</td>                                          
                                                @else
												  <td>
													<a href="{{ url('admin/employee-incident-view').'/'.$table->in_id}}">View</a>
													@if($table->manager_reject == 'Y') 
													 | <a href="{{ url('admin/employee-incident-edit').'/'.$table->in_id}}">Edit</a>
													@endif
												 </td>
											    @endif                                                
