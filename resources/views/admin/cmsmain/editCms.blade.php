...
@section('body')
    ...
    <div class="card">
        <div class="card-body">
            <form method="post" action="{{url('admin/cms-home-edit-store')}}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-12" style="clear:both">
                        <div class="form-group">
                            <label for="pwd">Informatic Banner</label>
                ...
                <div class="row">
                    <div class="col-md-12" style="clear:both">
                        <div class="form-group">
                            <label for="pwd">About Clinic </label>
                            <textarea id="content2" placeholder="" name="content{{$cms[1]->id}}" >{{old('content')?old('content'):$cms[1]->content}}</textarea>
                            @if($errors->has('content'))
                                <div class="invalid-feedback" style="display:block;">{{$errors->first('content')}}</div>
                            @endif
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12" style="clear:both">
                        <div class="form-group">
                            ...
                            <textarea id="content3" placeholder="" name="content{{$cms[2]->id}}" >{{old('content')?old('content'):$cms[2]->content}}</textarea>
                            @if($errors->has('content'))
                                <div class="invalid-feedback" style="display:block;">{{$errors->first('content')}}</div>
                            @endif
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12" style="clear:both">
                        <div class="form-group">
                            <label for="pwd">Additional Services </label>
                            <textarea id="content4" placeholder="" name="content{{$cms[3]->id}}" >{{old('content')?old('content'):$cms[3]->content}}</textarea>
                            @if($errors->has('content'))
                                <div class="invalid-feedback" style="display:block;">{{$errors->first('content')}}</div>
                            @endif
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12" style="clear:both">
                        <div class="form-group">
                            <label for="pwd">Online Appointment </label>
                            <textarea id="content5" placeholder="" name="content{{$cms[4]->id}}" >{{old('content')?old('content'):$cms[4]->content}}</textarea>
                            @if($errors->has('content'))
                                <div class="invalid-feedback" style="display:block;">{{$errors->first('content')}}</div>
                            @endif
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12" style="clear:both">
                        <div class="form-group">
                            <label for="pwd">Patient Information </label>
                            <textarea id="content6" placeholder="" name="content{{$cms[5]->id}}" >{{old('content')?old('content'):$cms[5]->content}}</textarea>
                            @if($errors->has('content'))
                                <div class="invalid-feedback" style="display:block;">{{$errors->first('content')}}</div>
                            @endif
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12" style="clear:both">
                        <div class="form-group">
                            <label for="pwd">
                            looking For</label>
                            <textarea id="content7" placeholder="" name="content{{$cms[6]->id}}" >{{old('content')?old('content'):$cms[6]->content}}</textarea>
                            @if($errors->has('content'))
                                <div class="invalid-feedback" style="display:block;">{{$errors->first('content')}}</div>
                            @endif
                        </div>
