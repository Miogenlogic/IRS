...
@section('body')
    ...
    <div class="card">
        <div class="card-body">
            <form method="post" action="{{url('admin/cms-service-page-edit-store')}}" enctype="multipart/form-data">

                <div class="row">
                    <div class="col-md-12">
                        <h4 style="padding:2px;" class="card-title"> Edit Service Page</h4>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12" style="clear:both">
                        <div class="form-group">
                            <label for="pwd">About Service Page</label>
