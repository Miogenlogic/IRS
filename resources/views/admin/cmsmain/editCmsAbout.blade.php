...
@section('body')
    ...
    <div class="card">
        <div class="card-body">
            <form method="post" action="{{url('admin/cms-about-edit-store')}}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-12" style="clear:both">
                        <div class="form-group">
                            <label for="pwd">About Our Clinic </label>
                ...
                <div class="row">
                    <div class="col-md-12" style="clear:both">
                        <div class="form-group">
                            <label for="pwd">Why Bioped </label>
                ...
                <div class="row">
                    <div class="col-md-12" style="clear:both">
                        <div class="form-group">
                            <label for="pwd">Our Core Values</label>
                ...
                <div class="row">
                    <div class="col-md-12" style="clear:both">
                        <div class="form-group">
                            <label for="pwd">Our Office </label>
