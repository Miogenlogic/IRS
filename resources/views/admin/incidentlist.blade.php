    ...
    <script>
        $(document).ready(function(){
            $('#table2').DataTable({
                ...
                serverSide: true,
                ajax:{
                    url: '{{ url("admin/inci-getTable") }}',
                },
                columns: [
                    //{data: 'DT_RowIndex', name: 'DT_RowIndex',orderable: false, searchable: false},
                    {data: 'id', name: 'id'},                    
                    {data: 'employee_name', name: 'employee_name'},
                    {data: 'incident_date', name: 'incident_date', orderable:false, searchable:false},
                    {data: 'incident_time', name: 'incident_time', orderable:false, searchable:false} ,
