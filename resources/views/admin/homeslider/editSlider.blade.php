...
@section('body')
    ...
    <div class="card">
        <div class="card-body">
            <form method="post" action="{{url('admin/home-slider-edit-store')}}" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6" style="clear:both">
                        <div class="form-group">
                            ...
                            @if($homeslider['image']!='')
                                ...
                                <img src="{{asset('public/assets/uploads/homeslider/image').'/'.$homeslider->image}}"  style="width:100px;height:100px;margin-top: 10px;">
