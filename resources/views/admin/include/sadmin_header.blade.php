                    ...
                    <div class="collapse navbar-collapse" id="main-navbar">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user-circle" aria-hidden="true"></i>Super Admin Menu</a>
                                <div class="dropdown-menu" aria-labelledby="dropdown01">
                                    <a class="dropdown-item" href="{{url('admin/employee-list')}}">Manage Employees</a>
                                    <!--<a class="dropdown-item" href="{{url('admin/zones-list')}}">Manage Zones</a>-->
                                    <a class="dropdown-item" href="{{url('admin/saftchamp-list')}}">Manage Location/BFunction Wise Safety Champion</a>	
                                    <a class="dropdown-item" href="{{url('admin/emp-saftchamp-list')}}">Manage Employee Wise Safety Champion</a>	
                                    <a class="dropdown-item" href="{{url('admin/edit-backDate')}}">Manage BackDate</a>	
									<a class="dropdown-item" href="{{url('admin/edit-repDays')}}">Manage Escalation Timeline</a>	
									<a class="dropdown-item" href="{{url('admin/inci-list')}}">Manage Incident Types</a>
									<a class="dropdown-item" href="{{url('admin/incistat-list')}}">Manage Incident Status Types</a>
									...
									<a class="dropdown-item" href="{{url('admin/schamp-report')}}">Download Employee Master</a>
