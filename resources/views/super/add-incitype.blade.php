...
@section('body')
        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-body">
                    <h1><span>Incident Type</span></h1>                    
                     <div class="tab-content">     
                            <form action="{{url('admin/add-incitype-save')}}" method="post">
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="form-group">
                                            <label for="" class="form-label">{{$title}}</label>
                                            <input name="incident_t" class="form-control" id="incident_t" type="text" placeholder="{{$title}}" value="{{$incitype}}">                                           
                                        </div>
                                    </div>
                                </div>
								...
								<div class="row">
                                    <div class="col-xl-12">
                                        <div class="form-group">
                                            <label for="" class="form-label">Auto Close</label>
                                           <select name="status" id="status" class="form-control">
										    <option value="N" {{ $autoClose == "N" ? 'selected' : ''}}>No</option>
											<option value="Y" {{ $autoClose == "Y" ? 'selected' : ''}}>Yes</option>
										   </select
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 text-centers">
                                    ...
                                    <input type="hidden" name="inci_type_id" value="{{$incitypeID}}">
                                    <button type="reset" class="btn btn-danger" onclick='location.href ="{{url('admin/inci-list')}}"'>Cancel</button>
