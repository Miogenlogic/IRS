                ...
                <div class="card-body">
                    <h1><span>{{$title}}</span></h1>                    
                     <div class="tab-content">     
                            <form action="{{url('admin/emp-add-schamp-save')}}" method="post">
								<div class="row">
                                    <div class="col-xl-12">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-centers">
                                    ...
                                    <button type="reset" class="btn btn-danger" onclick='location.href ="{{url('admin/emp-saftchamp-list')}}"'>Cancel</button>
