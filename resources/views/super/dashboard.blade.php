...
@section('body')
        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-body">
                    <h1><span>Welcome Super Administrator ({{$title}})!</span></h1>                   
                        ...
                        <div id="incidentInfo" class="tab-pane fade active show active">	
							 <ul class="incident-information d-flex justify-content-between">							
								 @php  //$Countall=App\Helpers\UserHelper::Countall(); 
                                        ...
                                        $Countall = $Pendingrm+$Close+$Pendingsh;
								 @endphp                                            
                                <li>
                                ...
                                <li>
                                    <div class="incidentNumberBlock ongoingIncident"><span class="incidentNumber">{{$Pendingsh}}</span><a href="{{url('admin/admin-pendsf')}}" class="incidentTxt">Pending Incidents with Safety Chamipon </a></div>
                                </li>
							  </ul>	
							  <ul class="incident-information d-flex justify-content-between">
