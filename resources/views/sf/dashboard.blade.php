                     ...
                     <div class="tab-content">
                        ...
                        <div id="incidentInfo" class="tab-pane fade active show active">
                            ...
                            <ul class="incident-information d-flex justify-content-between">
                                ...
                                <li>
                                    <div class="incidentNumberBlock closedIncident"><span class="incidentNumber">{{ $Pendingrm}}</span><a href="{{url('admin/admin-pendrm')}}" class="incidentTxt">Pending Incidents with Reporting Manager(s)</a></div>
                                </li>
                                 @php $Pendingsh=App\Helpers\UserHelper::Pendingsh(); @endphp
                                <li>
                                    <div class="incidentNumberBlock ongoingIncident"><span class="incidentNumber">{{$Pendingsh}}</span><a href="{{url('admin/admin-pendsf')}}" class="incidentTxt">Pending Self Incidents</a></div>
                                </li>
                                ...
                                <table id="tab_data" class="table table-striped">
                                    <thead>                                      
                                        ...
                                        @if(count($tabledata) > 0)  
                                            ...
                                            <td><a href="{{ url('admin/sf-incident-edit').'/'.$table->in_id}}">Edit</a> | <a href="{{ url('admin/sf-incident-view').'/'.$table->in_id}}">View</a></td>                                          
                                            </tr>
                                            @endforeach
                                            </tbody>
                                        @else 
...
/*$('#btnExport').click(function(event) {
    ...
    console.log(model);
    $.ajax({
        url: '{{ url("/admin/admin-exportdata?type=sf") }}',
        type: 'POST',
