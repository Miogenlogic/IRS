					...
					<div id="incidentInfo" class="tab-pane fade active show">
						...
						<form method="post" action="{{url('admin/sf-shcomment')}}" enctype="multipart/form-data">
							...
							<ul style="margin-top: 0;">
								...
								<input type="hidden" name="_token" value="{{csrf_token()}}">
								<li>								
									<button type="submit" class="btn-Dark" name="submitsf" value="submitsf" id="">Submit </button>
								 </li>
							</ul>
						...
						<br/>
						<div style="margin-top: 20px;">
							<label> <strong class="bold" style="font-size: 19px;padding: 5px 20px;border: 1px solid #e6e5e5;color: coral;">Safety Head comments table</strong></label>
						</div>						
							<table class="table table-striped">
								<thead>
									<tr>
