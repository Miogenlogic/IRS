...
+ function($) {
	...
	$(document).on('click.bs.sidebar.data-api', '[data-toggle="sidebar-approval"]', function(e) {
		var $this = $(this),
			href
	...
	$('html').on('click.bs.sidebar.autohide', function(event) {
		...
		var isButtonOrSidebar = $this.is('.sidebar, [data-toggle="sidebar-approval"]') || $this.parents('.sidebar, [data-toggle="sidebar-approval"]').length;
